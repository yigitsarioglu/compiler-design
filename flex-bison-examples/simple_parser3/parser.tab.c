...
static const char *const yytname[] =
{
  ...
  "FUNC", "LPAR", "RPAR", "LCURLY", "RCURLY", "PRINT", "SEMICOLON",
  "$accept", "program", "functions", "function", "statements", "statement",
  "variable", YY_NULLPTR
};
...
{
      17,    18,     5,     1,     6,    11,     8,    21,     9,    14,
      10,     7,     0,    20,    15,     0,     0,     0,     0,     0,
       0,    16
};

static const yytype_int8 yycheck[] =
{
       3,     4,     3,     5,     0,    10,     6,    11,     7,     6,
       8,     4,    -1,     7,     9,    -1,    -1,    -1,    -1,    -1,
      -1,    13
};
...
{
       0,     5,    13,    14,    15,     3,     0,    14,     6,     7,
       8,    10,    16,    17,     6,     9,    16,     3,     4,    18,
       7,    11
};
...
#line 1099 "parser.tab.c"
  ...
  case 5: /* function: FUNC IDENT LPAR RPAR LCURLY statements RCURLY  */
#line 46 "parser.y"
                                                         {printf("program ->  FUNC IDENT LPAR RPAR LCURLY RCURLY\n"); }
...
#line 1117 "parser.tab.c"
  ...
  case 8: /* statement: PRINT LPAR variable RPAR SEMICOLON  */
#line 51 "parser.y"
                                              { printf("statement -> PRINT LPAR variable RPAR\n");}
...
#line 1129 "parser.tab.c"
  ...
  case 10: /* variable: NUMBER  */
#line 54 "parser.y"
                   {printf("variable ->NUMBER %s\n", (yyvsp[0].sval)); }
